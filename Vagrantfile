...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define "core" do |core|
        core.vm.host_name = "andreas-weber.breeze-demo-app.dev"
        core.vm.network "private_network", ip: "192.168.56.150"

        core.vm.provider :virtualbox do |virtualbox|
            virtualbox.customize ["modifyvm", :id, "--name", "andreas-weber.breeze-demo-app.dev"]
        end
    end
